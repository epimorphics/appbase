...
public final class CorsFilter implements Filter {
    static Logger log = LoggerFactory.getLogger(CorsFilter.class);
    ...
    public void doFilter(final ServletRequest servletRequest,
        ...
        if (!(servletRequest instanceof HttpServletRequest) ||
            ...
            throw new ServletException("CorsFilter only supports http");
        }
    ...
    protected void handleSimpleCORS(final HttpServletRequest request,
        ...
        if (!(requestType == CorsFilter.CORSRequestType.SIMPLE ||
            ...
            throw new IllegalArgumentException("Illegal Cors request type");
        }
    ...
    protected void handlePreflightCORS(final HttpServletRequest request,
        ...
        if (requestType != CORSRequestType.PRE_FLIGHT) {
            throw new IllegalArgumentException("Illegal CORS request type, expected pre-flight");
        }
    ...
    protected static void decorateCORSProperties(
        ...
        if (request == null) {
            throw new IllegalArgumentException("Illegal cors request: null request");
        }
    ...
    private void parseAndStore(final String allowedOrigins,
        ...
        if (preflightMaxAge != null) {
            try {
                ...
                throw new ServletException("Illegal CORS max age", e);
            }
        }
    ...
    protected static boolean isValidOrigin(String origin) {
        if (origin.equals("null")) {
            // Firefox and Chrome use this for local file serving
            return true;
        }
